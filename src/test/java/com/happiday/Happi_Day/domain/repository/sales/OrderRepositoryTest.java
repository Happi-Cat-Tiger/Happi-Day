...
public class OrderRepositoryTest {
    ...
    @Test
    @DisplayName("판매글 주문 조회")
    public void findAllBySalesTest() {
        // given
        Pageable pageable = PageRequest.of(0, 12);

        // when
        Page<Order> foundOrder = orderRepository.findAllBySales(sales, pageable);

        // then
        assertThat(foundOrder.getContent().size()).isEqualTo(1);
        assertThat(foundOrder.getContent().get(0).getRefundAccountName()).isEqualTo("test refundAccountName");
    }
    ...
    public void findAllByUserTest() {
        ...
        // when
        Page<Order> foundOrder = orderRepository.findAllByUser(testUser, pageable);
